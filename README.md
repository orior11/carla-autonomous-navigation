...
| A\* planner — full A → B run in CARLA | ▶️ [Watch on YouTube]| Dijkstra planner — full A → B run in CARLA | ▶️ [Watch on YouTube]([https://youtu.be/REPLACE_WITH_DIJKSTRA_VIDEO_ID](https://youtu.be/e8b5mMvgPIM)) | |
